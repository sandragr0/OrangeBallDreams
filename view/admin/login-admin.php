...
<div class="container-fluid bg-lightgrey bg-gradient py-5 h-100">
    <div class="container formLogin bg-white shadow  rounded p-4">
        ...
        <div class="alert alert-danger mt-2 oculto" id="mensajeError3" role="alert">ERROR: El usuario o contraseña que
            has introducido no es correcto.
        </div>
        <?php
        ...
        <form onsubmit="return checkFormulario()" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <div class="alert alert-danger mt-2 oculto" id="mensajeError1" role="alert">Error: el campo nombre de
            ...
            <div class="mb-3">
                ...
                <div class="alert alert-danger mt-2 oculto" id="mensajeError2" role="alert">Error: el campo contraseña
