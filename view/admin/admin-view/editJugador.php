    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $objeto->getNombre() ?>">
            </div>
            <!-- Apellido 1 -->
            <div class="mb-3">
                <label for="apellido1" class="form-label" data-toggle="tooltip" data-placement="top" title="Obligatorio">Primer apellido *</label>
                <input type="text" class="form-control" id="apellido1" name="apellido1" value="<?php echo $objeto->getPrimerApellido() ?>">
            </div>
            <!-- Apellido 2 -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="telefono" name="telefono" value="<?php echo $objeto->getTelefono() ?>">
            </div>
        </div>
    </div>
    <div>
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="altura" name="altura" value="<?php echo $objeto->getAltura() ?>" aria-describedby="alturaHelp">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="biografia" name="biografia" name="biografia" class="form-control"><?php echo $objeto->getBiografia() ?></textarea>
                </div>
                <!-- Informe -->
                <div class="mb-3">
                    <label for="informe" class="form-label">Informe</label>
                    <textarea id="informe" name="informe" name="informe" class="form-control"><?php echo $objeto->getInforme() ?></textarea>
                </div>
            </div>
        </div>
    </div>
